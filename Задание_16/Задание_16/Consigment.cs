...
namespace Задание_16
{
    public struct Consigment
    {
        ...
        {
            return $"{Quantity} шт. по {Price.ToString("F2", System.Globalization.CultureInfo.InvariantCulture)} руб.";
        }
        public override bool Equals(object obj)
        {
            ...
            throw new ArgumentException("Объект не является Consigment");
        }
        ...
        public static Consigment operator -(Consigment x, Consigment y)
        {
            ...
            if (x.Quantity < y.Quantity)
                throw new ArgumentException("Нельзя вычесть большее количество");
